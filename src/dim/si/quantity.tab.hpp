...
/**
 ** \file ../quantity.tab.hpp
 ** Define the siquant::parser class.
 */
...
#ifndef YY_SIQUANT_QUANTITY_TAB_HPP_INCLUDED
# define YY_SIQUANT_QUANTITY_TAB_HPP_INCLUDED
...
# if defined YYDEBUG
#if YYDEBUG
#   define SIQUANTDEBUG 1
#  else
#   define SIQUANTDEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define SIQUANTDEBUG 0
# endif /* ! defined YYDEBUG */
#endif  /* ! defined SIQUANTDEBUG */

namespace siquant {
#line 204 "../quantity.tab.hpp"
...
#ifdef SIQUANTSTYPE
# ifdef __GNUC__
#  pragma GCC message "bison: do not #define SIQUANTSTYPE in C++, use %define api.value.type"
# endif
    typedef SIQUANTSTYPE value_type;
#else
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // unit
      // unit_literal
      char dummy1[sizeof (::dim::si::dynamic_quantity)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_unit_literal: // unit_literal
        value.move< ::dim::si::dynamic_quantity > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ::dim::si::dynamic_quantity&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ::dim::si::dynamic_quantity& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_unit: // unit
      case symbol_kind::S_unit_literal: // unit_literal
        value.template destroy< ::dim::si::dynamic_quantity > ();
        break;
    ...
    parser (::dim::si::detail::quantity_parser_driver& driver_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_SIQUANTEOF ()
      {
        return symbol_type (token::SIQUANTEOF);
      }
#else
      static
      symbol_type
      ...
      make_SIQUANTerror ()
      {
        return symbol_type (token::SIQUANTerror);
      }
#else
      static
      symbol_type
...
#endif // !YY_SIQUANT_QUANTITY_TAB_HPP_INCLUDED
