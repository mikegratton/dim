...
#if QUANTITYDEBUG || YYERROR_VERBOSE || 0
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, void* scanner, ::dim::si::dynamic_quantity* result)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (scanner);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, void* scanner, ::dim::si::dynamic_quantity* result)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, scanner, result);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, void* scanner, ::dim::si::dynamic_quantity* result)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, void* scanner, ::dim::si::dynamic_quantity* result)
{
  YYUSE (yyvaluep);
  YYUSE (scanner);
  YYUSE (result);
